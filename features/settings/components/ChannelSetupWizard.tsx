...
const PROVIDER_CONFIGS: Record<string, ProviderConfig> = {
  ...
  'instagram:meta': {
    name: 'Instagram API',
    description: 'API oficial da Meta para Instagram Direct Messages (Instagram Login).',
    official: true,
    fields: [
      {
        ...
        required: true,
        helpText: 'ID numérico da conta profissional Instagram. Encontra-se no Meta for Developers → Instagram API → Generate access tokens.',
      },
      {
        key: 'pageId',
        label: 'Instagram User ID (repetir)',
        type: 'text',
        placeholder: 'Ex: 17841400000000000',
        required: true,
        helpText: 'O mesmo ID acima — usado como endpoint de envio de mensagens (POST /{id}/messages).',
      },
      {
        key: 'accessToken',
        label: 'Access Token',
        ...
        placeholder: 'IGAAU...',
        required: true,
        helpText: 'Token gerado em Meta for Developers → Instagram API → Generate access tokens. Começa com IGAAU.',
      },
      {
        key: 'appSecret',
        ...
        required: false,
        helpText: 'Instagram App Secret — necessário para verificar assinaturas de webhook.',
      },
    ],
    setupUrl: 'https://developers.facebook.com/docs/instagram-platform/instagram-api-with-instagram-login/messaging-api',
    setupInstructions: [
      '1. Acede a developers.facebook.com → o teu app → Casos de utilização → Instagram API',
      '2. Copia o Instagram User ID da tabela "Generate access tokens"',
      '3. Clica "Generate token" e autentica com a conta Instagram',
      '4. Copia o token gerado (começa com IGAAU)',
      '5. Cola o User ID e o token nos campos abaixo',
    ],
  },
  'email:resend': {
    name: 'Resend',
