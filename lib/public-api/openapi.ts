// OpenAPI 3.1.2 "source of truth" for CRM Futuros Anúncios Public API (Integrations).
//
// NOTE:
...
export function getPublicApiOpenApiDocument(): OpenApiDocument {
  return {
    openapi: '3.1.2',
    info: {
      title: 'CRM Futuros Anúncios Public API',
      version: 'v1',
      description:
        'API pública do CRM Futuros Anúncios para integrações (n8n/Make). Produto em primeiro lugar: copiar → colar → testar.',
    },
