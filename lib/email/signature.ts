...
.sig-title{color:#8b5cf6!important;}
.sig-agency{color:#8892a4!important;}
...
<table class="sig-outer" cellpadding="0" cellspacing="0" border="0" width="520" bgcolor="#0d0a1e"
  ...
  <tr>
    <td class="sig-cell" bgcolor="#0d0a1e" style="padding:26px 30px 16px 30px;background-color:#0d0a1e;">
      <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="148" valign="middle" style="padding-right:20px;">
            <table cellpadding="0" cellspacing="0" border="0" width="148">
              <tr>
                <td class="sig-logo-border" bgcolor="#7C3AED" style="background:linear-gradient(135deg,#1B4FD8,#7C3AED,#EC4899);border-radius:14px;padding:2px;line-height:0;">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td class="sig-logo-bg" bgcolor="#07091c" style="background:#07091c;border-radius:12px;padding:6px;line-height:0;">
          ...
          <td valign="middle">
            <p class="sig-name" style="margin:0;padding:0;font-family:'Great Vibes',cursive;font-size:36px;font-weight:400;line-height:1.15;background:linear-gradient(90deg,#93c5fd 0%,#c4b5fd 55%,#f9a8d4 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;color:#c4b5fd;">Lic&#237;nia Sim&#245;es</p>
            <p class="sig-title" style="margin:7px 0 0 0;padding:0;font-family:'Outfit',Helvetica,Arial,sans-serif;font-size:10px;font-weight:600;letter-spacing:2.4px;text-transform:uppercase;color:#8b5cf6;">Gestora de Marketing Digital</p>
            <p class="sig-agency" style="margin:4px 0 0 0;padding:0;font-family:'Outfit',Helvetica,Arial,sans-serif;font-size:11px;font-weight:300;color:#8892a4;letter-spacing:.3px;">Ag&#234;ncia Futuros An&#250;ncios</p>
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td class="sig-cell" bgcolor="#0d0a1e" style="padding:0 30px 18px 30px;background-color:#0d0a1e;">
      <p class="sig-tagline" style="margin:0;padding:7px 0 7px 12px;font-family:'Outfit',Helvetica,Arial,sans-serif;font-size:10.5px;font-weight:300;font-style:italic;color:#7a8599;letter-spacing:.7px;border-left:2px solid #7C3AED;">Tr&#225;fego pago e presen&#231;a digital para a Constru&#231;&#227;o</p>
    </td>
  </tr>
  <tr>
    <td class="sig-cell" bgcolor="#0d0a1e" style="padding:0 30px 18px 30px;background-color:#0d0a1e;">
  ...
  <tr>
    <td class="sig-cell" bgcolor="#0d0a1e" style="padding:0 30px 16px 30px;background-color:#0d0a1e;">
        ...
        <tr>
          <td style="padding-right:22px;white-space:nowrap;vertical-align:middle;">
            <table cellpadding="0" cellspacing="0" border="0"><tr>
              ...
              <td style="vertical-align:middle;"><a href="tel:+351916493687" class="sig-contact" style="font-family:'Outfit',Helvetica,Arial,sans-serif;font-size:12px;font-weight:400;color:#94a3b8;text-decoration:none;white-space:nowrap;">916 493 687</a></td>
            </tr></table>
          </td>
          <td style="padding-right:22px;white-space:nowrap;vertical-align:middle;">
            <table cellpadding="0" cellspacing="0" border="0"><tr>
              <td style="padding-right:6px;vertical-align:middle;font-size:15px;line-height:1;color:#f472b6;">&#9993;</td>
              <td style="vertical-align:middle;"><a href="mailto:geral@futurosanuncios.com" class="sig-contact" style="font-family:'Outfit',Helvetica,Arial,sans-serif;font-size:12px;font-weight:400;color:#94a3b8;text-decoration:none;white-space:nowrap;">geral@futurosanuncios.com</a></td>
            </tr></table>
          </td>
          <td style="white-space:nowrap;vertical-align:middle;">
            <table cellpadding="0" cellspacing="0" border="0"><tr>
              <td style="padding-right:6px;vertical-align:middle;font-size:15px;line-height:1;color:#a78bfa;">&#8853;</td>
              <td style="vertical-align:middle;"><a href="https://futurosanuncios.com" class="sig-contact" style="font-family:'Outfit',Helvetica,Arial,sans-serif;font-size:12px;font-weight:400;color:#94a3b8;text-decoration:none;white-space:nowrap;">futurosanuncios.com</a></td>
            </tr></table>
          </td>
        </tr>
      </table>
  ...
  <tr>
    <td class="sig-cell" bgcolor="#0d0a1e" style="padding:0 30px 26px 30px;background-color:#0d0a1e;">
      <table cellpadding="0" cellspacing="0" border="0"><tr>
